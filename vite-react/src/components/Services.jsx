...
export function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Get regular insights through monthly reports or opt for one-time deep-dive analysis. We deliver as PDF reports, interactive dashboards, or both!',
      features: [
    ...
    },
    {
      ...
      description: 'Tailored analytics solutions designed specifically for your Shopify business needs and growth objectives.',
      features: [
    ...
    <div id="services" className="bg-gradient-to-b from-secondary-50 to-white">
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-primary-700 to-primary-900">
        <div className="max-w-4xl mx-auto text-center animate-on-scroll">
          ...
          <p className="text-xl text-primary-100 animate-slide-in-up stagger-1">
            Comprehensive analytics solutions to drive your business forward
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-in group hover:bg-primary-50/50 border border-secondary-100"
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-secondary-600 max-w-2xl mx-auto">
              We deliver as PDF reports, interactive dashboards, or both!
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-secondary-100">
              <FaFileAlt className="text-4xl text-primary-600 mb-6" />
              <h3 className="text-xl font-semibold mb-4 text-secondary-900">PDF Reports</h3>
              <p className="text-secondary-600 mb-4">
                Comprehensive monthly reports delivered as professional PDF documents with detailed insights, charts, and actionable recommendations.
              </p>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-secondary-100">
              <FaEye className="text-4xl text-primary-600 mb-6" />
              <h3 className="text-xl font-semibold mb-4 text-secondary-900">Interactive Dashboards</h3>
              <p className="text-secondary-600 mb-4">
      ...
      <section id="contact-section" className="py-24 px-6 bg-gradient-to-r from-primary-700 to-primary-900">
        <div className="max-w-4xl mx-auto text-center mb-16 animate-on-scroll">
          <h2 className="text-3xl font-bold text-white mb-6 animate-slide-in-up">Ready to Get Started?</h2>
          <p className="text-xl text-primary-100 animate-slide-in-up stagger-1">
